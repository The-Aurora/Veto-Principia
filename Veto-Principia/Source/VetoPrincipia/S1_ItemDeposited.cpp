...
US1_ItemDeposited::US1_ItemDeposited()
{
...
void US1_ItemDeposited::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void US1_ItemDeposited::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
float US1_ItemDeposited::GetMassInBox()
{
	// To avoid crash
